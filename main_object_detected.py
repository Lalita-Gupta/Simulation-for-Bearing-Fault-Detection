...
if choice_img != "Select one":
    ...
    if choice6 != "Select one":
        ...
        if choice6 == "Gamma Transformation":
            ...
            with col1:
                ...
                gamma_corrected1 = np.power(img1 / 255.0, gamma) * 255.0
                gamma_corrected1 = np.clip(gamma_corrected1, 0, 255).astype(np.uint8)
            ...
            with col2:
                ...
                # Perform gamma correction
                gamma_corrected2 = np.power(img2 / 255.0, gamma) * 255.0
                gamma_corrected2 = np.clip(gamma_corrected2, 0, 255).astype(np.uint8)
            ...
            with col3:
                ...
                # Perform gamma correction
                gamma_corrected3 = np.power(img3 / 255.0, gamma) * 255.0
                gamma_corrected3 = np.clip(gamma_corrected3, 0, 255).astype(np.uint8)
        ...
        if choice6 == "Log Transformation":
            ...
            with col1:
                ...
                log_transformed_image1 = cv2.merge((log_transformed_b, log_transformed_g, log_transformed_r))
            ...
            with col2:
                ...
                # Merge the log-transformed color channels back into an image
                log_transformed_image2 = cv2.merge((log_transformed_b, log_transformed_g, log_transformed_r))
            ...
            with col3:
                ...
                # Merge the log-transformed color channels back into an image
                log_transformed_image3 = cv2.merge((log_transformed_b, log_transformed_g, log_transformed_r))
        ...
        if choice6 == "Inverse Log Transformation":
            ...
            with col1:
                ...
                inv_log_transformed_image1 = cv2.merge((inv_log_transformed_b, inv_log_transformed_g, inv_log_transformed_r))
            ...
            with col2:
                ...
                # Merge the inverse log-transformed color channels back into an image
                inv_log_transformed_image2 = cv2.merge((inv_log_transformed_b, inv_log_transformed_g, inv_log_transformed_r))
            ...
            with col3:
                ...
                # Merge the inverse log-transformed color channels back into an image
                inv_log_transformed_image3 = cv2.merge((inv_log_transformed_b, inv_log_transformed_g, inv_log_transformed_r))
        ...
        if choice4 == "Gray Coloration":
            ...
            with col1:
                ...
                gray_image1 = cv2.cvtColor(transformed_image1, cv2.COLOR_RGB2GRAY)
            ...
            with col2:
                ...
                gray_image2 = cv2.cvtColor(transformed_image2, cv2.COLOR_RGB2GRAY)
            ...
            with col3:
                ...
                gray_image3 = cv2.cvtColor(transformed_image3, cv2.COLOR_RGB2GRAY)
        ...
        if choice4 == "HUE Coloration":
            ...
            with col1:
                ...
                hsv_image1 = cv2.cvtColor(transformed_image1, cv2.COLOR_RGB2HSV)
            ...
            with col2:
                ...
                # Convert BGR image to HSV
                hsv_image2 = cv2.cvtColor(transformed_image2, cv2.COLOR_RGB2HSV)
            ...
            with col3:
                ...
                # Convert BGR image to HSV
                hsv_image3 = cv2.cvtColor(transformed_image3, cv2.COLOR_RGB2HSV)
        ...
        if choice4 == "Pseudo Coloration":
            ...
            if choice5 == "Spring":
                ...
                with col1:
                    ...
                    pesudo_image1 = cv2.applyColorMap(transformed_image1, cv2.COLORMAP_SPRING)
                ...
                with col2:
                    ...
                    pesudo_image2 = cv2.applyColorMap(transformed_image2, cv2.COLORMAP_SPRING)
                ...
                with col3:
                    ...
                    pesudo_image3 = cv2.applyColorMap(transformed_image3, cv2.COLORMAP_SPRING)
            ...
            if choice5 == "Hot":
                ...
                with col1:
                    ...
                    pesudo_image1 = cv2.applyColorMap(transformed_image1, cv2.COLORMAP_HOT)
                ...
                with col2:
                    ...
                    pesudo_image2 = cv2.applyColorMap(transformed_image2, cv2.COLORMAP_HOT)
                ...
                with col3:
                    ...
                    pesudo_image3 = cv2.applyColorMap(transformed_image3, cv2.COLORMAP_HOT)
            ...
            if choice5 == "Cool":
                ...
                with col1:
                    ...
                    pesudo_image1 = cv2.applyColorMap(transformed_image1, cv2.COLORMAP_COOL)
                ...
                with col2:
                    ...
                    pesudo_image2 = cv2.applyColorMap(transformed_image2, cv2.COLORMAP_COOL)
                ...
                with col3:
                    ...
                    pesudo_image3 = cv2.applyColorMap(transformed_image3, cv2.COLORMAP_COOL)
            ...
            if choice5 == "Rainbow":
                ...
                with col1:
                    ...
                    pesudo_image1 = cv2.applyColorMap(transformed_image1, cv2.COLORMAP_RAINBOW)
                ...
                with col2:
                    ...
                    pesudo_image2 = cv2.applyColorMap(transformed_image2, cv2.COLORMAP_RAINBOW)
                ...
                with col3:
                    ...
                    pesudo_image3 = cv2.applyColorMap(transformed_image3, cv2.COLORMAP_RAINBOW)
            ...
            if choice5 == "HSV":
                ...
                with col1:
                    ...
                    pesudo_image1 = cv2.applyColorMap(transformed_image1, cv2.COLORMAP_HSV)
                ...
                with col2:
                    ...
                    pesudo_image2 = cv2.applyColorMap(transformed_image2, cv2.COLORMAP_HSV)
                ...
                with col3:
                    ...
                    pesudo_image3 = cv2.applyColorMap(transformed_image3, cv2.COLORMAP_HSV)
            ...
            if choice5 == "JET":
                ...
                with col1:
                    ...
                    pesudo_image1 = cv2.applyColorMap(transformed_image1, cv2.COLORMAP_JET)
                ...
                with col2:
                    ...
                    pesudo_image2 = cv2.applyColorMap(transformed_image2, cv2.COLORMAP_JET)
                ...
                with col3:
                    ...
                    pesudo_image3 = cv2.applyColorMap(transformed_image3, cv2.COLORMAP_JET)
    ...
    # For original = original_image1,2,3 
    # For applying transformation on - img1,2,3
    # After transformed = transformed_image1,2,3
    # After colored and tranformed - apply_image1,2,3
    # After filter and colored and tranformed - image_result
    # After edge = For edges1,2,3
    # To apply mask on - cut1,2,3
    # **************************************************************************************************************************************************************
